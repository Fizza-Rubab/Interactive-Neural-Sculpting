...
SAMPLING_REFINEMENT_STEPS = 3   # Refinement steps when sampling
...
class SDFSampler:
    ...
    def __next__(self):
        if not self.first_yield:
            ...
            with record_function("Sample Extension"):
